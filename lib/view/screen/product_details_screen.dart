        ...
        decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isSelected
                  ...
                  : AppTheme.TextSecondry.withOpacity(0.3),
            )),
        child: Center(
          child: Text(
            sizes[index],
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'By Brand Name',
                            style: TextStyle(
                                fontSize: 16, color: AppTheme.TextSecondry),
                          ),
                          SizedBox(height: 16),
                          Row(
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                    ...
                                    color:
                                        AppTheme.TextSecondry.withOpacity(0.5)),
                              ),
                            ],
                          )
                        ],
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: List.generate(
                                5, (index) => _buildSizeOption(index)),
                          ),
                          SizedBox(height: 24),
                          Text(
                            "Select Color",
                          ...
                          Row(
                            children: List.generate(
                                4, (index) => _buildColorOption(index)),
                          ),
                        ],
                      ),
                    ),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 12),
                                Text(
                                  "Great product! The quality is excellent and the fit is perfect. Highly recommended for anyone looking for a comfortable casual t-shirt",
                                  style: TextStyle(
                                      height: 1.5,
                                      color: AppTheme.TextSecondry),
                                )
                ...
                children: [
                  ...
                  Expanded(
                      child: GradientButton(
                          text: "Add to Cart - \$39.99", onPressed: () {}))
                ],
              ),
            ),
          )
